---
title: "The Cypherpunk Who Filed an S-1"
source: "https://drinkyouroj.substack.com/p/the-cypherpunk-who-filed-an-s-1"
author:
  - "[[Justin Hearn]]"
published: 2026-04-15
created: 2026-04-17
description: "Adam Back is taking a Bitcoin company public. If he's Satoshi, the SEC's disclosure rules are about to answer the question seventeen years of speculation couldn't."
tags:
  - "clippings"
---
When you file a patent, you swap anonymity for credit. The invention leaves your notebook and walks into the public record, stamped with your name. The clerk’s desk is an identity desk. Sign here.
...
There is another kind of clerk’s desk. This one belongs to the Securities and Exchange Commission. It doesn’t care about credit. It cares about $81 billion in undisclosed assets, signed for under penalty of fraud.

Adam Back is on his way to that desk.

![Split-frame illustration of two desks in a dark room. Left desk, lit by a single lamp: a sparse document labeled "Confidential Memorandum — 2008" with a pen. Right desk: towering stacks of SEC merger proxy statements, due diligence binders, and legal counsel documents stamped "Filed" and "Evidence."](https://substackcdn.com/image/fetch/$s_!kVri!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F15bd6046-aef7-4f1e-bc24-5f5fb794f60b_2048x1168.png)

2008: nine pages, no signature. 2026: Form DEFM14A, sign here.
...
The shape includes one last design feature. Satoshi built Bitcoin to survive without him. By the time he walked away in April 2011, the network was self-sustaining. The [estimated 1.1 million BTC](https://intel.arkm.com/explorer/entity/satoshi-nakamoto) under his control — roughly $81 billion now — has never moved. Seventeen years. Not a single outgoing transaction.
...
Then the inventor booked a return appointment.

## The Protocol: The S-1 Doesn’t Have a “No Comment” Box

*An S-1 is the registration statement a company files with the SEC to go public — a sworn, public disclosure of every material fact about the company and the people running it. SPACs like this one use a close cousin called the S-4, the merger-specific version filed when two companies combine rather than list independently. Different form number. Same legal exposure. You can deny being Satoshi to a reporter as many times as you want. The S-4 is a different conversation.*

The Exchange Act says that officers of public companies must disclose material information — facts a reasonable investor would consider important in an investment decision. A SPAC merger runs through S-4 proxies that name officer financial interests. Undisclosed assets that could move markets are not footnotes. They are the answer to whether the filing is honest.
...
## Personal Code: They Were Right About Everything Except the Exit

The Cypherpunk project was one of the most ambitious acts of preemptive political engineering of the late twentieth century. A group of mathematicians and cryptographers who saw what the internet was becoming and decided privacy and financial sovereignty were the same problem. They tried to solve it with code before the state understood what they were building.
