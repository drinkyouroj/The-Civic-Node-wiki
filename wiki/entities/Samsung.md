...
- **Tentative deal averts May 21 strike (May 20-21, 2026)**: Management and the National Samsung Electronics Union reached a tentative agreement ~90 minutes before the May 21 walkout was scheduled to begin. Terms: **12% of operating profit allocated to bonus pool (10.5% stock + 1.5% cash)**, no ceiling on DS-division payouts (the contested cap is removed), trigger thresholds at **200 trillion won (2026-2028) and 100 trillion won (2029-2035)**. The implementation timing of the new bonus-distribution method was delayed by one year. Strike formally suspended (not settled). **Ratification vote**: May 22–27 KST (2 PM Friday → 10 AM Tuesday); some outlets reported the window as May 21–28. Approximately 48,000–70,000 union members eligible to vote (variance in source reporting). KOSPI jumped ~8% on the news. *Sources: Seoul Economic Daily, TechTimes, wccftech, Japan Times, Bloomingbit, crypto briefing — source-page ingest pending raw file capture (deal coverage not yet in raw/).*
- **The deal terms as labor-extraction case**: This is the first major industrial labor action to extract a **permanent, profit-indexed share of an AI-chokepoint chokepoint's operating profit through 2035**, with no division-level ceiling. [[SK Hynix]] settled at 10% of annual OP, ~$460K–$477K per worker in 2026; the Samsung deal raises the chokepoint-labor benchmark to 12% with no cap on DS-division payouts. Editorial note: the deal indexes to operating *profit* rather than negotiating annual COLAs — different mechanism than postwar collective bargaining, and one that compounds with the chokepoint's pricing power rather than just keeping up with inflation.
...
- Does the May 22–27 ratification vote pass cleanly, or does it expose internal union faction tension between DS-division workers (who benefit most from the no-ceiling provision) and other divisions?
- If ratified, does the **profit-indexed bonus structure** spread to other chokepoint-labor pools ([[SK Hynix]], [[TSMC]], [[ASML]])? Worth tracking through 2026-Q3 wage-negotiation cycles in those companies.
- What is the long-run effect on Samsung's **hyperscaler customer pricing** (Apple, Amazon, Microsoft, OpenAI)? If 12% of DS-division operating profit is now indexed to a worker bonus pool through 2035, that incidence has to be absorbed somewhere — most likely in chip prices charged to AI buyers.
