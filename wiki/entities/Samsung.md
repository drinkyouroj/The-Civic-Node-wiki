...
- Does the shareholder lawsuit (Korea Shareholder Movement HQ, Commercial Act) succeed in challenging a profit-indexed bonus — i.e., can profit-share-as-contract survive a corporate-law test?
...
- What is the long-run effect on Samsung's **hyperscaler customer pricing** ([[Apple]], [[Amazon]], [[Microsoft]], [[OpenAI]])? If ~12% of DS-division operating profit is now indexed to a worker bonus pool through 2035, that incidence has to be absorbed somewhere — most likely in chip prices charged to AI buyers. *(This is the hyperscaler-PPA-chain weld the June 5 flagship will argue; the incidence-flows-to-chip-prices step is currently analytical inference, not yet sourced — see flagged GAP 4.)*
