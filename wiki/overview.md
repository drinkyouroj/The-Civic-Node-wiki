...
The wiki has grown from 31 source documents to **520** across over a dozen major thematic clusters. The dominant themes that emerged from the accumulated material are: the Trump administration's unprecedented intervention in monetary, regulatory, and platform-speech systems; the legal infrastructure being built around stablecoins and digital assets; the structural mechanisms (DEA quotas, jawboning, regulatory weaponization) by which state power is exercised through indirection; and the ongoing tension between AI systems marketed as autonomous and the human labor that actually makes them work.

**Update 2026-04-23**: Nine sources ingested across four converging clusters. **Iran / Hormuz escalation** (4 sources) documents a three-step tit-for-tat: the US seized the Iranian-flagged cargo ship [[US Seizes Iranian Cargo Ship Touska — BBC|Touska]] on Apr 19 with a direct engine-room strike; Iran retaliated Apr 22 by firing on three vessels and seizing two of them (the Greek-owned Epaminondas and the MSC Francesca, part of an MSC convoy of which four other vessels transited with AIS transponders disabled); Trump ordered the Navy via Truth Social on Apr 23 to "shoot and kill" Iranian small boats suspected of mine-laying. Brent crude broke $100/barrel; Vortexa data shows 10.7M barrels of Iranian crude still moving outbound despite the blockade — contradicts the "collapsing financially" narrative. The Lebanon-Israel direct talks (first bilateral since 1993) resumed in parallel. **AI governance** (3 sources) advances on three fronts: [[James Uthmeier|Florida AG Uthmeier]] opened the first U.S. state-level *criminal* investigation of a frontier AI lab ([[OpenAI]], over the April 2025 FSU shooting); a Discord group gained unauthorized access to [[Anthropic]]'s Mythos model via a third-party vendor contractor plus OSINT from the March Mercor breach — Project Glasswing's partner-testing governance model had its first documented failure; Sony's Nature-published "Ace" robot beat professional human table-tennis players with reinforcement learning, with Sony AI's own president volunteering the dual-use framing. **Fed independence** (1 source): [[Kevin Warsh]] endorsed monetary-policy independence at his Apr 21 Senate hearing — "strictly independent" — directly contradicting the "family fight" posture documented in earlier wiki sources. Sen. Tillis (R-N.C.) is blocking the nomination over the DOJ Powell investigation. **Drug policy** (1 source): [[Todd Blanche|Acting AG Blanche]] signed an Apr 23 order rescheduling FDA-approved and state-licensed medical marijuana to Schedule III, implementing a Biden-era direction via executive action; late-June DEA administrative hearing scheduled for broader Schedule I→III consideration. **Published**: [[The Process Is the Punishment]] (Apr 20 2026) — Doe v. Bonnell case study naming the "lawsuit is the punishment, not the verdict" pattern, cross-linked to the six existing ECF source pages. New entities: [[James Uthmeier]], [[Todd Blanche]]. Total wiki: ~1009 pages, 562 sources, 216 entities, 130 concepts, 87 articles.
