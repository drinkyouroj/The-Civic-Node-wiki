---
title: "The Abandonment Protocol"
type: article
...
created: 2026-04-07
updated: 2026-04-07
source: "published/The Abandonment Protocol.md"
---
...
1. The spark — Christine's final reappearance and death; the neural pathway trained by her disappearance/return cycle; "death doesn't announce itself"
2. The pattern — three versions of the same absence: Christine (involuntary, death), parents (algorithmic capture of cognitive bandwidth), psychiatric ward (containment economics)
3. The protocol — the contagion model of attention loss; how algorithmic capture metastasizes through social networks; "you can't be present for someone else when your presence has been captured by an algorithm"
4. Personal code — what can be controlled; refusing to participate in own containment; guarding attention as finite resource; writing as the attempt to catalyze change in others
