...
Zitron is a tech journalist with a critical perspective on AI industry narratives. His methodology — reconstructing actual revenue from historical ARR reports — is imperfect by his own admission (lacking some months of data). The analysis is directionally important even if some specific figures are estimates. Published August 2025.

**ARR trajectory update (reconciled):** The Sherwood News report (October 2025) cites Anthropic at $7B ARR heading toward $9B by year-end — the figure Zitron called "total bullshit" in August. The number appears to have materialized. This does not undermine Zitron's core argument: his critique was of the *metric itself* (ARR ≠ actual revenue, ARR ≠ profit, ARR is selectively disclosed during fundraising rounds to create false impressions), not a prediction that Anthropic would fail to reach $9B ARR. Both things are true: Anthropic hit the ARR target AND the metric is still being used misleadingly to conflate revenue run-rate with business viability. The burn rate vs. revenue gap analysis remains the more important story.
