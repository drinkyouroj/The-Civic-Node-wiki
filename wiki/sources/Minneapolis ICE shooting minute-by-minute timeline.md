...
## Key Points
- Detailed timestamped reconstruction of the shooting sequence
- Shows 6-minute gap between first shot and EMS arrival
- Documents conflicting orders given by ICE agents
- ICE agents blocked physician bystander from checking Good's pulse
...
## Notes
Lightweight ingest. The Wikipedia article incorporates this timeline; this source provides the original investigative reconstruction.
