...
| U.S. provided | Saudi Arabia (and OPEC) provided |
|---|---|
...
| Eurodollar banking infrastructure | Stabilization of OPEC pricing discipline |
...
- [[Nixon Shock]] — the event that necessitated the Petrodollar System's creation
- [[GENIUS Act]] — sometimes framed as extending petrodollar logic into digital finance; the analogy is rhetorical not mechanical
- [[Stablecoin Legislation]] — the T-bill reserve requirement as digital petrodollar (contested)
- [[Narrow Banking and the Chicago Plan]] — the actual analytical lens for what GENIUS does
- [[Dollarization via Stablecoins]] — the empirically richer story about what stablecoins actually do
- [[Strategic Bitcoin Reserve]] — potential hedge if petrodollar system weakens
- [[Chokepoint Control]] — oil infrastructure control is inseparable from petrodollar power
- [[Operator View of Crypto Regulation]] — the framing that makes the petrodollar/stablecoin analogy contested
