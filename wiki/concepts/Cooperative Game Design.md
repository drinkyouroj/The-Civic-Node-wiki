---
title: "Cooperative Game Design"
type: concept
tags: [technology, game-design, cooperation, culture]
created: 2026-04-17
updated: 2026-04-17
sources: 5
---
...
1. **Game-theory writing**: Justin's game-theory pieces about cooperation vs. sociopathy can point to Arc Raiders as a natural experiment.
2. **Structure shapes behavior**: If small design changes in a game's XP economy can flip the dominant player strategy from predation to cooperation, the much larger incentive structures in human economic and political life are presumably also more malleable than "human nature" arguments suggest.
3. **Algorithmic co-constitution**: Cooperation in Arc Raiders is not purely organic — it is partly maintained by [[Aggression-Based Matchmaking]]. The pro-social outcome depends on active algorithmic management. That's a useful reminder that "cooperative cultures" in any domain may be infrastructure, not spontaneous order.
