...
- "In a world where..."
- "The landscape is changing" / "the changing landscape of [anything]"
- "Comprehensive guide" / "Ultimate guide" / "Definitive guide" / "Everything you need to know" (instant deletion trigger for the TCN reader)
- "10 things you should know" / "X things you need to know"
- "Here's what you need to know"
- "Hot take" (the audience reads for synthesis, not takes)
- "Smart money" / "dumb money" (tribal and reductive)
- "Experts say" / "according to experts"
- "We need to talk about..." (beaten to death as a Substack subject line)
...
**Banned outright:**
- "WAGMI" / "HFSP" / "Have fun staying poor"
- "GM" as a greeting (cringe in 2026)
- "Money printer go brrr" (the meme is dead)
- "LFG" / "let's gooo" / any bro-coded enthusiasm
- "Web3" as a self-identifier (the term is dead in 2026; "crypto" is back as the noun)
- "The space" as a generic crypto reference (signals lack of specificity)

**Use only as deliberate irony, never sincere:**
