...
- Inline source links: 19 (up from 18 in v2)
...
- **Context corrected:**
  - Force 4: "including China, South Korea, and Canada" → "including China, South Korea, Canada, and Mexico" — Futurism source lists four countries; Mexico was dropped in the v2 reconciliation pass

- **Link added:**
  - Force 4: "[Apple](wccftech url)" — WCCFTech/Korea Economic Daily article documenting Apple executives booking extended hotel stays near Samsung's Hwaseong complex to negotiate DRAM LTAs. Best available direct sourcing for named hyperscaler procurement behavior. Amazon and Microsoft are covered by the Article 1 context established in the opener; no dedicated wiki source documents their specific contracts independently.

- **Skipped / unresolved:**
  - Amazon and Microsoft DRAM/HBM contract sourcing: no dedicated primary source in the wiki covers these two companies' specific procurement agreements. Covered implicitly by Article 1. Flag for future sourcing if a Tier 1-2 source surfaces (e.g., Amazon/Microsoft earnings call language, investor relations filings, or direct reporting on their DRAM LTAs).

- **Wiki audit:** 19 source links in v3
  - Already ingested (wiki/sources/): 18 ✓
  - Article 1 cross-reference (wiki/articles/): 1 ✓
  - In raw/ only: 0
