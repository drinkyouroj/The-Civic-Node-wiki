...
Three rule changes shaped the network before either of those votes landed. [HIP-53](https://github.com/helium/HIP/blob/main/0053-mobile-dao.md) set the data transfer rate at $0.50 per gigabyte. [HIP-138](https://eng.ambcrypto.com/how-much-can-you-really-earn-with-helium-hotspots-in-2025/) consolidated the IoT and Mobile subnetwork tokens into a single HNT in January 2025. The [August 2025 halving](https://blog.helium.com/helium-halving-2025-8ecaa1fff464) cut new emissions in half. Each change had its own stated rationale. All three had a defensible rationale at the time.
