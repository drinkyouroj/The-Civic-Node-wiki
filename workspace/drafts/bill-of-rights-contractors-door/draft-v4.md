...
**Status:** Draft v4 (review — post-fact-check reconciliation pass 3)
...
**Previous version:** `workspace/drafts/bill-of-rights-contractors-door/draft-v3.md`
...
The gap isn't a policy violation. An ATF intelligence specialist named Keya Chavies ran three searches tagged "ERO assist" using APD-issued Flock credentials. Chavies was a federal employee, not an Atlanta officer. Atlanta's sanctuary policy governs Atlanta officers; it says nothing about what a federal agent can do with Atlanta's account.
...
**Draft notes:**
- Word count: ~1,567 (was ~1,575 in v3; -8 net from §4 ¶2 sentence deletion and Chavies/Ventura wording trims)
...
- Inline source links: 14 (was 13 in v3; +1 from Oregon SB 1516 OLIS primary-text link added in §4 ¶1)
...
- Wiki audit: 14 inline source URLs total (was 13 in v3; +1 Oregon SB 1516 OLIS)
  - Already ingested as wiki source pages: 11 (was 10; +1 Oregon SB 1516 enrolled bill text)
    ...
    - olis.oregonlegislature.gov SB 1516 → `wiki/sources/Oregon SB 1516 — Enrolled Bill Text.md`
  ...
  - New raw files created during this reconciliation: 0
