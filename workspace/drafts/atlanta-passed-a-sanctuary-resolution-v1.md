...
Two people appear by name in the audit. [David Stribling](https://atlpresscollective.com/2025/11/13/atlanta-police-flock-immigration-searches/), an APD investigator, ran twelve of those searches, all tagged "locate alien." APD states he was assigned at the time to an FBI task force on transnational fraud and has since retired. Keya Chavies ran the other three, tagged "ERO assist." Chavies is identified on LinkedIn as an ATF Intelligence Specialist based in Atlanta. She was not an APD employee; she was using APD-issued Flock credentials.

Those fifteen searches are the portion of the picture with names on them. The rest: [APD ran 323,292 Flock searches in 2025](https://atlpresscollective.com/2025/11/13/atlanta-police-flock-immigration-searches/). APD's cameras were queried 10.6 million times by approximately 4,500 agencies. U.S. Border Patrol accounted for 3,254 of those searches; external agencies flagging immigration keywords accounted for 3,383. Flock's system doesn't just capture plates — it builds a vehicle "fingerprint": plate, make and model, bumper stickers, body damage. Each search doesn't return a plate. It returns a profile.
...
- Claims flagged for verification:
  - **$156,000 deportation defense grant** — cited via ACPC Nov 2025 article; verify the figure appears in that piece or identify the specific city council vote record
  - **SAFE Cities Network membership 2017** — mentioned in opener; verify the year (some sources say 2016–2017); add specific link to SAFE Cities Network documentation
  - **Georgia HB 1105 (2024)** — no inline link; add a link to Georgia legislative record or news coverage of the bill's passage
  - **Flock "Search Safeguards" blog URL** — used as source for both the keyword filter architecture and the January 2026 toggle; confirm the exact URL resolves correctly before publication
  - **Operation Metro Surge** — described without an external link; verify the operation name and add a link to a primary news source (MPR, Star Tribune, or similar); the wiki synthesis is the current only source
  - **Renée Good killing, January 7, 2026, Minneapolis** — described as "killed in Minneapolis" without specifying the circumstances; add a link to a verified news source (Star Tribune, MPR News) before publication; do not characterize the circumstances beyond what the source confirms
  - **APD's activation status on Flock's keyword filter and federal-sharing toggle** — stated as "unknown" in the draft, which is accurate; if APD responds to a press inquiry before publication, update accordingly
