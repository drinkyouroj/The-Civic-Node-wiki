...
- Links added:
  - GBPI inline on "Georgia HB 1105" (Source Code ¶1) — resolves carry-over LOW unsourced claim from v1/v2/v3
  - ThinkProgress inline on "Atlanta's 2017 City Council resolution" (Source Code ¶2) — resolves carry-over LOW unsourced claim from v1/v2/v3
- Skipped / unresolved: none
- All flagged items from prior fact-checks are now resolved.

**Wiki audit — sources linked in v4:** All 10 sources fully ingested in wiki/sources/ (no raw-only stubs remain).
...
- `https://gbpi.org/gbpis-statement-on-the-signing-of-house-bill-1105/` — ingested ✓ (new in v4)
- `https://thinkprogress.org/atlanta-pd-ice-detainers-ce1f323edca0/` — ingested ✓ (new in v4)
