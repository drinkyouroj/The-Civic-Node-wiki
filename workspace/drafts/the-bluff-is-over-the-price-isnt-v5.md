...
1. **Opener TurboQuant scope (Claim #1):**
   - Old: "compresses AI inference memory 6x"
   - New: "compresses the working memory of AI inference by 6x"
   - Reason: "AI inference memory" overstated the scope; TurboQuant compresses the KV cache specifically. "Working memory of AI inference" aligns with Force 1's precise language ("the KV cache — the working memory of AI inference") without introducing the unexplained jargon term in the opener.

2. **Draft notes link count:**
   - Old: "19 (unchanged from v3)"
   - New: "21"
   - Reason: Actual count is 21 (2 opener links + 19 body links). The "19" figure was an error carried from v3 draft notes, which also totaled 21.

**Skipped / unresolved:**
- Amazon/Microsoft procurement sourcing (Unsourced Claim C): no Tier 1–2 source available in wiki; residual noted for future sourcing

**Wiki audit — 21 sources linked, all confirmed in wiki/sources/:**
- research.google/blog/turboquant (×2) → TurboQuant - Redefining AI efficiency with extreme compression ✓
- drinkyouroj.substack.com/p/the-71-billion-bluff → published Article 1 (internal reference) ✓
- timesofindia.indiatimes.com/...openai-hardware-crisis → How Sam Altman's OpenAI may have caused the worst consumer hardware crisis ✓
- trendforce.com/news/2026/03/31/... (×2) → DDR5 Retail Prices Pullback Amid Market Correction ✓
- npr.org/sections/planet-money/.../jevons-paradox → Why the AI world is suddenly obsessed with a 160-year-old economics paradox ✓
- forbes.com/sites/tiriasresearch/2026/04/07/... (×3) → Helium Crisis Tightens Grip On Global Chip Supply Chain ✓
- digitimes.com/news/a20260329PR200/... → 2026 Global Helium Supply Crisis — DigiTimes ✓
- archive.ph/9uWnx → An Invisible Bottleneck - Helium Shortage Threatens the Chip Industry ✓
- reuters.com/.../samsung-flags-eight-fold-jump → Samsung Flags Eightfold Jump in Q1 Profit — Reuters ✓
- reuters.com/.../samsung-elec-workers-strike... (×3) → Samsung workers' strike plan would disrupt chip supply ✓
- futurism.com/science-energy/data-centers-construction-supply (×2) → Almost Half of US Data Centers Slated to Be Canceled or Delayed ✓
- bloomberg.com/news/articles/2026-03-06/oracle-and-openai... → Stargate Data Center Expansion Cancelled — Oracle and OpenAI ✓
- wccftech.com/apple-executives-booking-extended-hotel-stays... → Apple Executives Booking Extended Hotel Stays for DRAM LTA ✓
- tomshardware.com/pc-components/dram/chinas-cxmt-and-ymtc... → CXMT and YMTC to Expand Memory Output ✓
