...
>   - Scenes 01, 02, 04, 09, 10 → **full-bleed typography, no rail** (the big rhetorical beats get the whole frame).
...
01's `100 : 1`, the refrains, `NOT THE SAME MONEY`, `NOT YET.`) use
...
### Scene 09 — `sl-lead` (bullet listing) · TEASE · 10 beats · full-bleed, no face

**Kicker:** `DISPATCH №006 · TEASE`
**Thumbnail anchor:** `NOT YET.` at `--type-hero` (full-bleed, final beat).
...
- **B10** "Not yet." → stark card `NOT YET.` at `--type-hero` (full-bleed), hairline above, `sl-glow` behind. **Hold ~1.5s — last open loop before the CTA.**
...
### Scene 10 — `sl-end` · END · 5 beats · full-bleed, no face
